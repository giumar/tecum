...
<div class="users index content">
    <?= $this->Html->link(__('Nuovo utente'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Users') ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('Mostra'), ['action' => 'view', $user->id]) ?>
                        <?= $this->Html->link(__('Modifica'), ['action' => 'edit', $user->id]) ?>
                        <?= $this->Form->postLink(__('Cancella'), ['action' => 'delete', $user->id], ['confirm' => __('Sei sicuro di voler cancellare # {0}?', $user->id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
